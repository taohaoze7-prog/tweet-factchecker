# AGENTS.md — Tweet FactChecker（集成主干 / main）
...
backend/   (FastAPI + Python 3.12)
  ...
  agents/      claim / evaluator / critic   ← 2 号线 agent-layer（真实 Codex agent）
  core.py      单断言收敛 + 聚合
...
模型分层：claim=`Codex-haiku-4-5`，evaluator/critic=`Codex-sonnet-4-6`。
